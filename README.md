...
2. Update `/SSoTmeProject.json` to replace `ej-aca-yesand` with `bob-your-project`
3. Update `/DotNet/CLIClassLibrary/EAPICLIHandler.cs` to replace `ej-aca-yesand` with `bob-your-project`.
4. Update `/package.json` to replace `ej-aca-yesand` with `bob-your-project`.
